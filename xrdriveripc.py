...
CONFIG_ENTRIES = {
    ...
    'invert_x': [parse_boolean, False],
    'invert_y': [parse_boolean, False],
    'invert_z': [parse_boolean, False],
    ...
    'use_pitch_adjustment_override': [parse_boolean, False],
    'pitch_adjustment_degrees': [parse_float, 0.0],
